...
#        endif
void process_rgb_matrix_typing_heatmap_minv(uint8_t row, uint8_t col) {
...
//                HSV hsv = {170 - qsub8(val, 85), rgb_matrix_config.hsv.s, scale8((qadd8(170, val) - 170) * 3, rgb_matrix_config.hsv.v)};
                HSV hsv = {170 - qsub8(val, 85), rgb_matrix_config.hsv.s, max((qadd8(170, val) - 170) * 3, rgb_matrix_config.hsv.v)};
